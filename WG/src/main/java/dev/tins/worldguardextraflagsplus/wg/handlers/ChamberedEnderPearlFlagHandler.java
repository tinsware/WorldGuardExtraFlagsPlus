...
public class ChamberedEnderPearlFlagHandler extends FlagValueChangeHandler<State>
{
	...
	private void handleValue(LocalPlayer player, World world, State state)
	{
		...
		ChamberedEnderPearlPearlTracker.setPlayerInFlaggedRegion(bukkitPlayer.getUniqueId(), nowInFlaggedRegion);
	}
}
